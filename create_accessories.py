...
IMAGE_PATH = '/Users/noname/learn/django/auto/static/images/accessories/'
PRODUCTS_PATH = '/Users/noname/learn/django/auto/scrape/accessories.csv'
...
def createall():
    ...
    for index, item in data.iterrows():
        ...
        cat = AccessoriesCategory.objects.get_or_create(
            name = category
        )[0]
        new_product = AccessoriesItem(
            category = cat,
            sku = sku,
            name = name,
            price = price,
